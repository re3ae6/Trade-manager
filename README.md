# Trade Manager V2.10.0 — Compact Cockpit UI
...
The About dialog shows the current app version (`v2.10.0`) and developer signature in a native-looking in-app modal rather than a browser alert.
